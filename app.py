...
with gallery_tab:
    ...
    default_image = "Mona Lisa (Leonardo da Vinci)"
    default_index = options.index(default_image) if default_image in options else 0
    file_name = st.selectbox("Select Art", options=options, index=default_index)
...
st.sidebar.write("---\n")
st.sidebar.caption("""You can check out the source code [here](https://github.com/anshk1234/Pixa-Art).
